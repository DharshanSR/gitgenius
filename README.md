...
| Command | Description | Example |
|---------|-------------|---------|
| `gitgenius pr` | Create AI-powered PR | `gitgenius pr` |
| `gitgenius pr --title <title>` | Set PR title | `gitgenius pr --title "Fix bug"` |
| `gitgenius pr --draft` | Create draft PR | `gitgenius pr --draft` |
| `gitgenius pr --target <branch>` | Target branch | `gitgenius pr --target develop` |
| `gitgenius pr --reviewers <list>` | Request reviewers | `gitgenius pr -r "john,jane"` |

### Logging & Debugging

| Command | Description | Example |
|---------|-------------|---------|
| `gitgenius logs` | View GitGenius logs | `gitgenius logs` |
| `gitgenius logs --lines 100` | Show specific lines | `gitgenius logs --lines 100` |
| `gitgenius logs --stats` | Log statistics | `gitgenius logs --stats` |
| `gitgenius logs --export <file>` | Export logs | `gitgenius logs --export debug.json` |
| `gitgenius errors` | View error tracking | `gitgenius errors` |
| `gitgenius errors --stats` | Error statistics | `gitgenius errors --stats` |
| `gitgenius debug --enable` | Enable debug mode | `gitgenius debug --enable` |
| `gitgenius debug --performance` | Performance metrics | `gitgenius debug --performance` |

📖 **[Learn more about Logging](docs/LOGGING.md)**
